...
const Navbar = () => {
  ...
  function createUser() {
    if(!regEmailInpValue.trim() || !regPasswordInpValue.trim() || !regSecondPasswordInpValue.trim() || !regLogInpValue.trim()){
  ...
  return (
    <div className="navBlock">
      { localStorage.email ? (      <div className="navContainer">
          ...
          {inputs ? (
            ...
            <div className="modalContent">
              ...
              <div className="authModule">
                ...
                />
                <div className="loginBtn" onClick={loginUser}>Войти</div>
              </div>
            </div>
          ) : (
            ...
            <div className="modalContent ">
              ...
              <div className="regModule">
                ...
                />
                <div className="regBtn" onClick={createUser}>Зарегистрироваться</div>
              </div>
            </div>
          )}
        </div>
